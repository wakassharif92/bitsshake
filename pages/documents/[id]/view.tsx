...
export default function ViewDocument() {
  ...
  const signers = recipients.filter((r) => r.role === "signer");
  const viewers = recipients.filter((r) => r.role !== "signer");
  const allSignersSigned =
    signers.length > 0 && signers.every((r) => r.status === "signed");
  ...
  return (
    <div className="min-h-screen bg-gray-50 text-slate-900">
        ...
        <div className="max-w-7xl mx-auto px-4 py-6 sm:px-6 lg:px-8">
          <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
            <div className="flex items-start gap-4">
              {!isPublicView && (
                <Link href="/dashboard">
                  <button className="mt-1 flex h-11 w-11 shrink-0 items-center justify-center rounded-full border border-slate-200 bg-slate-950 text-white shadow-sm transition-colors hover:bg-slate-800 cursor-pointer">
                    <svg
              ...
              <div className="max-w-3xl">
                ...
                <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-600">
                  Review the agreement, track signer progress, and manage
            ...
            <div className="flex w-full flex-col gap-3 lg:max-w-sm lg:items-end">
              <div className="grid w-full gap-3 sm:grid-cols-2 lg:grid-cols-1">
                <button
                  ...
                  className="flex min-h-12 items-center justify-center rounded-2xl bg-slate-950 px-5 py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-slate-800 disabled:cursor-not-allowed disabled:bg-slate-300 cursor-pointer"
                  title={
                    !hasAccess
                      ? "Upgrade to download"
                      : allSignersSigned
                ...
                {isDocumentAdmin && (
                  <div className="relative" ref={sendPopoverRef}>
                    <button
                      ...
                      className="flex min-h-12 w-full items-center justify-center rounded-2xl border border-slate-200 bg-white px-5 py-3 text-sm font-semibold text-slate-800 shadow-sm transition hover:border-slate-300 hover:bg-slate-50 disabled:cursor-not-allowed disabled:bg-slate-100 disabled:text-slate-400 cursor-pointer"
                    >
                    ...
                    {showSendPopover && (
                      <div className="absolute right-0 z-50 mt-2 w-full overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-2xl shadow-slate-900/10">
                        <button
                          ...
                          className="block w-full px-4 py-3 text-left text-sm font-medium text-slate-900 transition hover:bg-slate-50 cursor-pointer"
                          disabled={sendingDocument || !hasAccess}
                        >
                          Send via Email
                        </button>
              ...
              {isDocumentAdmin && (
                <div className="grid w-full gap-3 sm:grid-cols-2">
                  <button
                    ...
                    className="flex min-h-11 items-center justify-center rounded-2xl border border-slate-200 bg-white px-4 py-3 text-sm font-medium text-slate-700 transition hover:border-slate-300 hover:bg-slate-50 disabled:cursor-not-allowed disabled:bg-slate-100 disabled:text-slate-400 cursor-pointer"
                  >
                  ...
                  {canRevertDocument && (
                    <button
                      ...
                      className="flex min-h-11 items-center justify-center rounded-2xl border border-rose-200 bg-rose-50 px-4 py-3 text-sm font-medium text-rose-700 transition hover:bg-rose-100 disabled:cursor-not-allowed disabled:bg-slate-100 disabled:text-slate-400 cursor-pointer"
                    >
      ...
      <main className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8 lg:py-10">
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-[minmax(0,1.75fr)_minmax(340px,0.9fr)]">
          {/* Document content */}
          <div>
            <div className="overflow-hidden rounded-[28px] border border-white/70 bg-white shadow-[0_24px_80px_rgba(15,23,42,0.08)]">
              <div className="border-b border-slate-100 bg-[linear-gradient(135deg,#f8fafc,white_55%,#eef2ff)] px-8 py-6 sm:px-10">
                ...
                <div className="mt-3 flex flex-wrap items-center gap-3 text-sm text-slate-500">
                  ...
                  <span className="h-1 w-1 rounded-full bg-slate-300" />
                  <span>{attachedInvoices.length} invoices linked</span>
                </div>
              </div>
                      ...
                      {signers.map((recipient) => (
                        ...
                        >
                          ...
                          <p
                            ...
                            className="mb-2 mt-4 text-slate-900"
                          >
                              ...
                              isAdmin && (
                                <div className="mt-3">
                                  <div className="flex items-center gap-2">
                                    <span className="break-all rounded-xl border border-slate-200 bg-white px-2 py-1.5 text-xs text-slate-600">
                                      {link}
                                    </span>
                                    <button
                                      onClick={() => {
                                      ...
                                      disabled={!hasAccess}
                                      className="rounded-full bg-slate-950 px-3 py-1.5 text-xs text-white transition-colors hover:bg-slate-800 disabled:opacity-50 cursor-pointer"
                            ...
                            >
                              <div className="flex items-start justify-between mb-3 gap-2">
                                <Link href={`/invoices/${attachedInvoice.id}`}>
                                  <p className="text-sm font-medium text-slate-900 hover:underline cursor-pointer">
                    ...
                    {auditLogs.length === 0 ? (
                      ...
                      aggregatedAuditLogs.map((entry) => (
                        <div
                          ...
                          className="mb-3 rounded-2xl border border-slate-200 bg-slate-50 p-4 text-sm"
                        >
